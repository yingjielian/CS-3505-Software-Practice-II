...
// This serves as the deconstructor for the Trie class. It calls a method in the node calls to aid in deleting all the 
// nodes and their pointers in the Trie.
Trie::~Trie(){
...
// This method serves as a override for the = operator. Now it serves as the same function as the copy constructor, except 
// you dont need to generate a new Trie, it overwrites the (this) Trie.
...
// This method returns all the words that begin with the desired input prefix. To do this it uses a method from the 
// Node class called retrieveWords.
